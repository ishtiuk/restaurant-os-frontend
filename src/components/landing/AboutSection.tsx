                    ...
                    <div className="space-y-8 animate-fade-in-left">
                        <div className="space-y-4">
                            ...
                            <p className="text-muted-foreground text-lg leading-relaxed">
                                Founded in 2025, RysTRO was born from a simple observation: great food deserves great technology. We saw restaurant owners struggling with fragmented tools, messy spreadsheets, and outdated POS systems.
                            </p>
                            <p className="text-muted-foreground text-lg leading-relaxed">
                                We built RysTRO to be the operating system for modern dining—seamlessly connecting orders, kitchen, inventory, and analytics in one intuitive platform.
                            </p>
                        </div>
